...
- generated: `2026-08-28T20:54:40+00:00`
- run nonce: `mlkit-20260828T205434Z-e5ab199ea393`
- mlkit: `0.2.0` at `0a776b8ac54d2312896191d668b079457d7763f1`
...
| chokepoint | `feat/r6-horizon-ladder-and-uq` | `6112f87f2b3c` | DIRTY |
| fray | `feat/r6-serving-and-uncertainty` | `ff5550d002ea` | clean |
| surge | `feat/observed-corpus-and-fabrication-gates` | `9eab2fe80177` | clean |
| torrent | `feat/r6-attributes-and-scale` | `6d59ed8a49dc` | DIRTY |
...
| fray/forecast_available | forecast_available+nbr/k=15/hgb/leaves=63/lr=0.1/iter=300 | forecast_available+nbr/k=15/hgb/leaves=63/lr=0.1/iter=300 | mae | test | 82.75377957333798 | persistence_t_minus_1 | 113.06701205090663 | yes | NA (models_of_record.json carries no test-read counter or l… |
...
| fray/spatial_infill | `reports/validation/models_of_record.json` (main) | `dff258e6c1bbbb175609ff290e7eed69034f3c6daf14d73abed8edaefb2d3a1e` | 11041 | yes | no | checkout @ `feat/r6-serving-and-uncertainty` `ff5550d002ea` |
| fray/forecast_available | `reports/validation/models_of_record.json` (main) | `dff258e6c1bbbb175609ff290e7eed69034f3c6daf14d73abed8edaefb2d3a1e` | 11041 | yes | no | checkout @ `feat/r6-serving-and-uncertainty` `ff5550d002ea` |
| torrent/melstm-10ep-n8-val | `reports/train/seed_summary_n8_val.json` (main) | `7d0c1d9ee48e98f0e216d0a8aa252565864b70e2ccef03bb3fb6f771c158ddd4` | 17468 | yes | no | checkout @ `feat/r6-attributes-and-scale` `6d59ed8a49dc` |
| torrent/melstm-10ep-n8-val | `reports/holdout_reads.jsonl` (ledger) | `f3f431a499855b549be77544828555c33dfd95ab7da8e2f05b3573f02172145c` | 754 | yes | no | checkout @ `feat/r6-attributes-and-scale` `6d59ed8a49dc` |
| torrent/ridge-vs-melstm-val | `reports/train/row_parity_ridge_vs_melstm_val.json` (main) | `28fd9ace2517f5329ee9ff0c79a22c7dd389eaa5a586a739ccead2a85d416aad` | 1289 | yes | no | checkout @ `feat/r6-attributes-and-scale` `6d59ed8a49dc` |
| torrent/ridge-vs-melstm-val | `reports/holdout_reads.jsonl` (ledger) | `f3f431a499855b549be77544828555c33dfd95ab7da8e2f05b3573f02172145c` | 754 | yes | no | checkout @ `feat/r6-attributes-and-scale` `6d59ed8a49dc` |
| chokepoint/level-head | `models/episode_response/champion.json` (main) | `c03ffc16660bbb6fa6b9aff09d8613a3a2729aa377aa4afadd76f2cd955fbcae` | 11250 | yes | no | checkout @ `feat/r6-horizon-ladder-and-uq` `6112f87f2b3c` |
| chokepoint/direction-head | `models/episode_response/champion.json` (main) | `c03ffc16660bbb6fa6b9aff09d8613a3a2729aa377aa4afadd76f2cd955fbcae` | 11250 | yes | no | checkout @ `feat/r6-horizon-ladder-and-uq` `6112f87f2b3c` |
